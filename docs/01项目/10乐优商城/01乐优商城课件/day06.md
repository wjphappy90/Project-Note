...
![1530555871804](assets/61530555871804.png)

我们解压缩，放到工作目录中：

![1530367369490](assets/61530367369490.png)



然后在Intellij idea中导入新的工程：

![1530367589197](assets/61530367589197.png)

选中我们的工程：

 ![1530367781173](assets/61530367781173.png)



这正是一个用vue-cli构建的webpack工程，是不是与昨天的一样：

 ![1530368191250](assets/61530368191250.png)
...
![1530368695265](assets/61530368695265.png)

我们只需要打开终端，进入项目目录，输入：`npm install`命令，即可安装这些依赖。

![1530374769782](assets/61530374769782.png)

大概需要几分钟。

**如果安装过程出现以下问题**：

![1530374827792](assets/61530374827792.png)
...
![1530374954209](assets/61530374954209.png)

发现默认的端口是9001。访问：http://localhost:9001

会自动进行跳转：

![1525958950616](assets/61530375152204.png)
...
![1530555978248](assets/61530555978248.png)
...
![1525960312939](assets/61525960312939.png)



我们重点关注`UI components`即可，里面有大量的UI组件，我们要用的时候再查看，不用现在学习，先看下有什么：

 ![1525961862771](assets/61525961862771.png)

 ![1525961875288](assets/61525961875288.png)
...
首先是目录结构图：![1525962755237](assets/61525962755237.png)
...
![1525964023585](H:/%E4%B9%90%E4%BC%98/day06-%E5%90%8E%E5%8F%B0%E7%AE%A1%E7%90%86%E9%A1%B5%E9%9D%A2/assets/61525964023585.png)
...
![1530380040278](assets/61530380040278.png)
...
- `v-navigation-drawer` ：导航抽屉，主要用于容纳应用程序中的页面的导航链接。 
      ...
      ![1530380237867](assets/61530380237867.png)

- `v-toolbar `：工具栏通常是网站导航的主要途径。可以与导航抽屉一起很好地工作，动态选择是否打开导航抽屉，实现可伸缩的侧边栏。

  ![1530380292558](assets/61530380292558.png)
...
![1530556073565](assets/61530556073565.png)

解压，运行exe文件，效果：

![1530382550630](assets/61530382550630.png)
...
![1530382601757](assets/61530382601757.png)

OK！

通过域名访问：

![1530383586463](assets/61530383586463.png)

原因：我们配置了项目访问的路径，虽然manage.leyou.com映射的ip也是127.0.0.1，但是webpack会验证host是否符合配置。

![1530383612716](assets/61530383612716.png)

在webpack.dev.conf.js中取消host验证：

![1530383927461](assets/61530383927461.png)

重新执行`npm run dev`，刷新浏览器：

![1530384150852](assets/61530384150852.png)
...
### 4.4.1.什么是Nginx
 ...
 ![1526187409033](assets/61526187409033.png)
...
![1526016663674](assets/61526016663674.png)
...
![img](assets/60C36B84E.gif) 

我们在本地安装一台nginx：

![1530556268445](assets/61530556268445.png)

解压后，目录结构：

![1530384792790](assets/61530384792790.png)
...
示例：
 ...
 ![1526188831504](assets/61526188831504.png)
...
![1530385404783](assets/61530385404783.png)
...
![1530385593052](assets/61530385593052.png)

现在实现了域名访问网站了，中间的流程是怎样的呢？

![1526189945180](assets/61526189945180.png)
...
![1525999005260](assets/61525999005260.png)
...
![1530556389224](assets/61530556389224.png)

我们先看商品分类表：

 ![1525999774439](assets/61525999774439.png)
...
![1530413709515](assets/61530413709515.png)

商品分类之间是会有层级关系的，采用树结构去展示是最直观的方式。

一起来看页面，对应的是/pages/item/Category.vue：

 ![1530386186299](assets/61530386186299.png)
...
![1530427294644](assets/61530427294644.png)
...
![1530427514123](assets/61530427514123.png)
...
在`ly-item-interface`中添加category实体类：
 ...
 ![1530444682670](assets/61530444682670.png)
...
![1530445885707](assets/61530445885707.png)
...
添加Controller：
 ...
 ![1530450599897](assets/61530450599897.png)
...
一般service层我们会定义接口和实现类，不过这里我们就偷懒一下，直接写实现类了：
 ...
 ![1530450744567](assets/61530450744567.png)
...
![1530455133230](assets/61530455133230.png)

然后试试网关是否畅通：http://api.leyou.com/api/item/category/list

![1530455291468](assets/61530455291468.png)

一切OK！

然后刷新后台管理页面查看：

![1530455437899](assets/61530455437899.png)
...
![1530460311064](assets/61530460311064.png)
...
结构：
 ...
 ![1530462650711](assets/61530462650711.png)



重启测试，访问正常：

![1530463010927](assets/61530463010927.png)
...
![1526021968036](assets/61526021968036.png)
...
为了方便看到效果，我们新建一个MyBrand.vue（注意先停掉服务器），从0开始搭建。
 ...
 ![1530464178834](assets/61530464178834.png)
...
![1530464255544](assets/61530464255544.png)

打开服务器，再次查看页面：

![1530464304721](assets/61530464304721.png)
...
![1526023540226](assets/61526023540226.png)
...
![1526023837773](assets/61526023837773.png)
...
- loading：boolean类型，true：代表数据正在加载，会有进度条。false：数据加载完毕。
  ...
  ![1526029254159](assets/61526029254159.png)
...
![1530518876942](assets/61530518876942.png)
...
![1526029445561](H:/%E4%B9%90%E4%BC%98/day06-%E5%90%8E%E5%8F%B0%E7%AE%A1%E7%90%86%E9%A1%B5%E9%9D%A2/assets/61526029445561.png)
...
![1530523252532](assets/61530523252532.png)
...
![1530523838357](assets/61530523838357.png)
...
![1530524238344](assets/61530524238344.png)

因为新增跟某个品牌无关，是独立的，因此我们可以放到表格的外面。

![1530527129881](assets/61530527129881.png)

效果：

![1530527160208](assets/61530527160208.png)
...
![1526031159242](assets/61526031159242.png)
...
![1530532504861](assets/61530532504861.png)
...
![1526031897445](assets/61526031897445.png)
...
![1530533261856](assets/61530533261856.png)

发现输入框超级长！！！

这个时候，我们可以使用Vuetify提供的一个空间隔离工具：

![1530533442878](assets/61530533442878.png)
...
![1530534269196](assets/61530534269196.png)
...
查看textfiled的文档，发现：
 ...
 ![1526033007616](assets/61526033007616.png)
...
![1530534311458](assets/61530534311458.png)
...
![1526033439890](assets/61526033439890.png)
...
![1530534423194](assets/61530534423194.png)
...
### 7.2.2.实体类
 ...
 ![1530541070271](assets/61530541070271.png)
...
### 7.2.3.mapper
 ...
 ![1530541222679](assets/61530541222679.png)
...
另外，这个PageResult以后可能在其它项目中也有需求，因此我们将其抽取到`leyou-common`中，提高复用性：
 ...
 ![1530543778541](assets/61530543778541.png)
...
接下来，我们编写Controller
 ...
 ![1530549253999](assets/61530549253999.png)
...
### 7.2.5.Service
 ...
 ![1530549286718](assets/61530549286718.png)
...
![1530549095150](assets/61530549095150.png)
...
Vue官方推荐的ajax请求框架叫做：axios，看下demo：
 ...
 ![1526033988251](assets/61526033988251.png)
...
而在我们的项目中，已经引入了axios，并且进行了简单的封装，在src下的http.js中：
 ...
 ![1526034150067](assets/61526034150067.png)
...
- http.js中导入了config的配置，还记得吗？
   ...
   ![1526041205846](assets/61526041205846.png)
...
我们在组件`MyBrand.vue`的getDataFromServer方法，通过$http发起get请求，测试查询品牌的接口，看是否能获取到数据：
 ...
 ![1526048221750](assets/61526048079191.png)

网络监视：

 ![1526048143014](assets/61526048143014.png)

resp到底都有那些数据，查看控制台结果：

![1526048275064](assets/61526048275064.png)
...
![1530553414937](assets/61530553414937.png)
...
![1530554422695](assets/61530554422695.png)

效果：

![1530554460215](assets/61530554460215.png)
...
![1526049643506](assets/61526049643506.png)

成功实现分页功能：

![1526049720200](assets/622.gif)
...
分页实现了，过滤也很好实现了。过滤字段对应的是search属性，我们只要监视这个属性即可:
 ...
 ![1526049939985](assets/61526049939985.png)

查看网络请求：

 ![1526050032436](H:/%E4%B9%90%E4%BC%98/day06-%E5%90%8E%E5%8F%B0%E7%AE%A1%E7%90%86%E9%A1%B5%E9%9D%A2/assets/61526050032436.png)

页面结果：

![1530555740595](assets/61530555740595.png)
