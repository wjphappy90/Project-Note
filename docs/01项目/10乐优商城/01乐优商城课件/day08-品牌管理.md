...
![1526115791468](assets/81526115791468.png)
...
首先，我们在data中定义一个show属性，来控制对话框的显示状态：
 ...
 ![1526116451280](assets/81526116451280.png)
...
![1526118714621](assets/81526118714621.png)
...
效果：
 ...
 ![1526119096686](assets/81526119096686.png)
...
我们新建一个`MyBrandForm.vue`组件：
 ...
 ![1526119788914](assets/81526119788914.png)
...
页面效果：
 ...
 ![1526128384960](assets/81526128384960.png)
...
![1526128476264](assets/81526128476264.png)
...
先看文本框，昨天已经用过的，叫做`v-text-field`：
 ...
 ![1526129519056](assets/81526129519056.png)
...
![1526131172190](assets/81526131172190.png)
...
这样的选框，在Vuetify中并没有提供（它提供的是基本的下拉框）。因此我已经给大家编写了一个无限级联动的下拉选框，能够满足我们的需求。
 ...
 ![1526131637045](assets/81526131637045.png)
...
效果：
 ...
 ![1526132934902](assets/81526132934902.png)

data中获取的结果：

 ![1526133224362](assets/81526133224362.png)
...
在Vuetify中，也没有文件上传的组件。
 ...
 ![img](assets/80B26B319.gif) 

还好，我已经给大家写好了一个文件上传的组件：

 ![1526133576597](assets/81526133576597.png)
...
最终结果：
 ...
 ![1526136024649](assets/81526136024649.png)
...
首先，在表单上定义`ref`属性：
 ...
 ![1526137891067](assets/81526137891067.png)

然后，在页面查看`this.$refs`属性：

![1526138030853](assets/81526138030853.png)
...
![1526138441735](assets/81526138441735.png)

校验规则的写法：

![1526138475159](assets/81526138475159.png)
...
效果：
 ...
 ![1526139379209](assets/81526139379209.png)
...
- 6、弹窗提示成功还是失败，这里用到的是我们的自定义组件功能message组件：
   ...
   ![1526140298249](assets/81526140298249.png)
...
我们填写表单并提交，发现报错了：
 ...
 ![1526180888663](assets/81526180888663.png)

查看控制台的请求详情：

 ![1526180937974](assets/81526180937974.png)
...
QS是一个第三方库，我们可以用`npm install qs --save`来安装。不过我们在项目中已经集成了，大家无需安装：
 ...
 ![1526181889564](assets/81526181889564.png)
...
发现其中有3个方法：
 ...
 ![1526181747560](assets/81526181747560.png)
...
测试一下，使用浏览器工具，把qs对象保存为一个临时变量：
 ...
 ![1526182053758](assets/81526182053758.png)

然后调用stringify方法：

 ![1526182230872](assets/81526182230872.png)
...
![1526181301670](assets/81526181301670.png)

然后再次发起请求：

 ![1526181331443](assets/81526181331443.png)

发现请求成功：

 ![1526181358204](assets/81526181358204.png)

参数格式：

 ![1526181384653](assets/81526181384653.png)

数据库：

 ![1526181553737](assets/81526181553737.png)
...
- 第三步，子组件通过`this.$emit`调用父组件的函数：
 ...
 ![1526216993249](assets/81526216993249.png)
...
![1526192299113](assets/81526192299113.png)

![1526192347113](assets/81526192347113.png)
...
结构：
 ...
 ![1526192931088](assets/81526192931088.png)
...
我们通过RestClient工具来测试：
 ...
 ![1526196967376](assets/81526196967376.png)

结果：

 ![1526197027688](assets/81526197027688.png)

去目录下查看：

 ![1526197060729](assets/81526197060729.png)
...
查看页面的请求路径：
 ...
 ![1526196446765](assets/81526196446765.png)
...
![1526200471676](assets/81526200471676.png)
...
再次测试：
 ...
 ![1526200606487](assets/81526200606487.png)

不过，非常遗憾的是，访问图片地址，却没有响应。

 ![1526200927268](assets/81526200927268.png)
...
先上图：
 ...
 ![1526205318630](assets/81526205318630.png)
...
> 上传
 ...
 ![1526205664373](assets/81526205664373.png)
...
> 下载
 ...
 ![1526205705687](assets/81526205705687.png)
...
参考课前资料的：《centos安装FastDFS.md》
 ...
 ![1526205975025](assets/81526205975025.png)
...
地址：[tobato/FastDFS_client](https://github.com/tobato/FastDFS_Client)
 ...
 ![1526206304954](assets/81526206304954.png)
...
![1526215187172](assets/81526215187172.png)

访问最后一个路径（缩略图路径），注意加组名：

 ![1526215257110](assets/81526215257110.png)
...
通过RestClient测试：
 ...
 ![1526215940805](assets/81526215940805.png)

## 3.6.页面测试上传

发现上传成功：

 ![1526216133300](assets/81526216133300.png)

不过，当我们访问页面时：

 ![1526216178123](assets/81526216178123.png)
...
修改我们的hosts：
 ...
 ![1526216272835](assets/81526216272835.png)



再次上传：

 ![1526216322359](assets/81526216322359.png)
...
![1526216494380](assets/81526216494380.png)
...
然后编写事件，改变show 的状态：
 ...
 ![1526217622765](assets/81526217622765.png)
...
- 第一步：在编辑时获取当前选中的品牌信息，并且记录到data中
  ...
  先在data中定义属性，用来接收用来编辑的brand数据：
   ...
   ![1526218080029](assets/81526218080029.png)
...
- 第三步：在子组件中通过props接收要编辑的brand数据，Vue会自动完成回显
  ...
  接收数据：
   ...
   ![1526218243761](assets/81526218243761.png)
...
测试：发现数据回显了，除了商品分类以外：
 ...
 ![1526219653994](assets/81526219653994.png)
...
再次测试：数据成功回显了
 ...
 ![1526222999115](assets/81526222999115.png)
...
第一步：在父组件中记录状态：
 ...
 ![1526224372366](assets/81526224372366.png)



第二步：在新增和修改前，更改状态：

 ![1526224447288](assets/81526224447288.png)

第三步：传递给子组件

 ![1526224495244](assets/81526224495244.png)

第四步，子组件接收标记：

 ![1526224563838](assets/81526224563838.png)



标题的动态化：

 ![1526224628514](assets/81526224628514.png)
